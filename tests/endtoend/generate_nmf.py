...
# def compute_test_nmf(
#     test_name, json_file, input_file=None, row_header=0, w=None, h=None, n_components=1, sparsity=0, n_bootstrap=0
# ):
#     expected_estimator_ = {}
#     with open(DATA_PATH / json_file, "r") as ifile:
#         decoded_array = json.load(ifile)
...
#     ),
#     compute_test_ntf(
#         test_name="test_ntf_with_sparsity_bootstrap",
